...
pub static COMMANDS: &[Spec] = &[
    ...
    // The container for everything about slots. Arity is a minimum of two
    // because the word on its own is a wrong number of arguments, and the flags
    // are empty on the container itself, since each subcommand carries its own
    // and the container is never the thing that runs.
    Spec {
        name: "cluster",
        arity: -2,
        flags: &[],
    ...
    // none of them touches a key, and `ASKING` is the only one that changes
    // anything about the connection it is sent on.
    Spec {
        name: "asking",
        arity: 1,
        flags: &["fast"],
        ...
        since: "3.0.0",
        complexity: "O(1)",
        summary: "Let the next command into a slot this node is receiving.",
        group: "connection",
    },
    Spec {
        name: "readonly",
        ...
        since: "3.0.0",
        complexity: "O(1)",
        summary: "Take reads from a replica rather than being redirected.",
        group: "connection",
    },
    Spec {
        name: "readwrite",
        ...
        since: "3.0.0",
        complexity: "O(1)",
        summary: "Undo READONLY and go back to being redirected.",
        group: "connection",
    },
    Spec {
        name: "role",
