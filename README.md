...
There is nothing to install. Every package below is published at `0.0.1`, holds a name, and raises the moment you call anything in it. One version number covers all of them, which is the same rule the real releases will follow.
